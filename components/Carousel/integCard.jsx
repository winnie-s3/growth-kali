export function IntegCard({intImage, integTitle, integText}) {
    return(
        <div className="gap-2 p-5 w-64 h-64 flex justify-center flex-col items-center bg-miniCard text-white mr-5 hover:shadow-[inset_0px_-28px_31px_-32px_#A0E00D]">
